...
public:
	...
	*/
	...
	/*!
		...
		\param t The transform applied to this polygon.
	...
	*/
	...
	/*!
		...
		\sa GetCollision()
	*/
	const bool Contains(const Circle &c, const Transform &t1, const Transform &t2) const;
	...
	*/
	...
	const unsigned GetAxesCount() const;

	const Axis GetTransformedAxis(const unsigned i , const Transform &t) const;
	...
	*/
	const Vector2 NearestVertex(const Vector2 &point, const Transform &t) const;
